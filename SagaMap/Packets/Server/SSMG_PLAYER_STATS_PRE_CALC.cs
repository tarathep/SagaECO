namespace SagaMap.Packets.Server
{
    ...
    /// <summary>
    /// Defines the <see cref="SSMG_PLAYER_STATS_PRE_CALC" />.
    /// </summary>
    public class SSMG_PLAYER_STATS_PRE_CALC : Packet
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SSMG_PLAYER_STATS_PRE_CALC"/> class.
        /// </summary>
        ...
        public ushort HP
        {
            set
            {
                this.PutUShort(value, (ushort)64);
            }
        }
        ...
        public ushort MP
        {
            set
            {
                this.PutUShort(value, (ushort)66);
            }
        }
        ...
        public ushort SP
        {
            set
            {
                this.PutUShort(value, (ushort)68);
            }
        }
        ...
        public ushort Capacity
        {
            set
            {
                this.PutUShort(value, (ushort)70);
            }
        }
        ...
        public ushort Payload
        {
            set
            {
                this.PutUShort(value, (ushort)72);
            }
        }
    }
}
