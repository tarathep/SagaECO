namespace SagaMap.Skill.SkillDefinations.Explorer
{
    ...
    /// <summary>
    /// Defines the <see cref="BirdAnalysis" />.
    /// </summary>
    public class BirdAnalysis : ISkill
    {
        ...
        public int TryCast(ActorPC sActor, SagaDB.Actor.Actor dActor, SkillArg args)
        {
            if (dActor.type == ActorType.MOB)
            {
                ...
                mobTypeList.Add(MobType.BIRD);
                mobTypeList.Add(MobType.BIRD_BOSS);
                mobTypeList.Add(MobType.BIRD_BOSS_SKILL);
                mobTypeList.Add(MobType.BIRD_NOTOUCH);
                mobTypeList.Add(MobType.BIRD_SPBOSS_SKILL);
                mobTypeList.Add(MobType.BIRD_UNITE);
                mobTypeList.Add(MobType.BIRD);
                mobTypeList.Add(MobType.BIRD_BOSS);
                mobTypeList.Add(MobType.BIRD_BOSS_SKILL);
                mobTypeList.Add(MobType.BIRD_NOTOUCH);
