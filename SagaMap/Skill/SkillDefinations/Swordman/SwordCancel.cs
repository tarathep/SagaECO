namespace SagaMap.Skill.SkillDefinations.Swordman
{
    ...
    /// <summary>
    /// Defines the <see cref="SwordCancel" />.
    /// </summary>
    public class SwordCancel : ISkill
    {
        ...
        private bool CheckPossible(SagaDB.Actor.Actor sActor)
        {
            ...
            return actorPc.Inventory.Equipments.ContainsKey(EnumEquipSlot.RIGHT_HAND) && (actorPc.Inventory.Equipments[EnumEquipSlot.RIGHT_HAND].BaseData.itemType == ItemType.SWORD || actorPc.Inventory.Equipments[EnumEquipSlot.RIGHT_HAND].BaseData.itemType == ItemType.RAPIER || actorPc.Inventory.GetContainer(ContainerType.RIGHT_HAND2).Count > 0);
        }
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            if (!this.CheckPossible(possesionedActor))
                return;
            int lifetime = 20000;
            DefaultBuff defaultBuff = new DefaultBuff(args.skill, possesionedActor, nameof(SwordCancel), lifetime);
