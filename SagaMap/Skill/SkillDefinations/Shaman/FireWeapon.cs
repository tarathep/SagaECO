namespace SagaMap.Skill.SkillDefinations.Shaman
{
    ...
    /// <summary>
    /// Defines the <see cref="FireWeapon" />.
    /// </summary>
    public class FireWeapon : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultBuff defaultBuff = new DefaultBuff(args.skill, dActor, nameof(FireWeapon), 50000);
        ...
        private void StartEventHandler(SagaDB.Actor.Actor actor, DefaultBuff skill)
        {
            ...
            (attackElements = actor.AttackElements)[Elements.Fire] = attackElements[Elements.Fire] + num;
