namespace SagaMap.Skill.SkillDefinations.Enchanter
{
    ...
    /// <summary>
    /// Defines the <see cref="SoulOfWater" />.
    /// </summary>
    public class SoulOfWater : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultBuff defaultBuff = new DefaultBuff(args.skill, dActor, nameof(SoulOfWater), lifetime);
        ...
        private void StartEventHandler(SagaDB.Actor.Actor actor, DefaultBuff skill)
        {
            ...
            skill.Variable.Add("SoulOfWater_mdef", (int)num1);
            actor.Status.mdef_skill += num1;
            if (skill.Variable.ContainsKey("SoulOfWater_mdef_add"))
                skill.Variable.Remove("SoulOfWater_mdef_add");
            skill.Variable.Add("SoulOfWater_mdef_add", (int)num2);
            actor.Status.mdef_add_skill += num2;
