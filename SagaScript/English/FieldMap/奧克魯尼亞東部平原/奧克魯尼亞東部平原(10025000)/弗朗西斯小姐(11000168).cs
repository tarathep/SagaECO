...
namespace SagaScript.M10025000
{
    public class S11000168 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            if (!World_01_mask.Test(World_01.Wing_decoration_synthesis_task_completed))
            {
                翅膀裝飾合成任務(pc);
                return;
            }
        ...
        void 翅膀裝飾合成任務(ActorPC pc)
        {
            ...
            if (World_01_mask.Test(World_01.Wing_decoration_synthesis_task_begins))
            {
                製作翅膀裝飾(pc);
                return;
            }
            ...
            {
                case 1:
                    World_01_mask.SetValue(World_01.Wing_decoration_synthesis_task_begins, true);
        ...
        void 製作翅膀裝飾(ActorPC pc)
        {
            ...
            {
                World_01_mask.SetValue(World_01.Wing_decoration_synthesis_task_completed, true);
