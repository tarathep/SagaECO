namespace SagaMap.Skill.SkillDefinations.Druid
{
    ...
    /// <summary>
    /// Defines the <see cref="TranceSpdUp" />.
    /// </summary>
    public class TranceSpdUp : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(TranceSpdUp), ifActivate);
        ...
        {
            skill[nameof(TranceSpdUp)] = (int)skill.skill.Level * 3;
        }
