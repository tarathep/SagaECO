namespace SagaMap.Skill.SkillDefinations.Elementaler
{
    ...
    internal class EarthNum : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            int num1 = 0;
            int lifetime = 0;
            Singleton<SkillHandler>.Instance.MagicAttack(sActor, dActor, args, Elements.Earth, 0.0f);
            ...
            float num2 = 0.0f;
            int element = dActor.Elements[Elements.Earth];
            ...
            if (SagaLib.Global.Random.Next(0, 99) >= num3)
                return;
            Stone stone = new Stone(args.skill, dActor, lifetime);
            SkillHandler.ApplyAddition(dActor, (Addition)stone);
        }
    }
}
