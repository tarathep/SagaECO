namespace SagaMap.Skill.SkillDefinations.Merchant
{
    ...
    /// <summary>
    /// Defines the <see cref="SellRateUp" />.
    /// </summary>
    public class SellRateUp : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(SellRateUp), ifActivate);
        ...
        private void StartEventHandler(SagaDB.Actor.Actor actor, DefaultPassiveSkill skill)
        {
            ...
            skill["SellRate"] = num;
            actor.Status.sell_rate += (short)num;
        }
