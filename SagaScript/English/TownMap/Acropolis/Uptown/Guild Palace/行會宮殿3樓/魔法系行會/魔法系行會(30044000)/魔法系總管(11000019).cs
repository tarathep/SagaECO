...
namespace SagaScript.M30044000
{
    public class S11000019 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            if (Job2X_06_mask.Test(Job2X_06.Defense_is_too_high))//_4A13)
            {
                ...
                if (pc.Inventory.Equipments.Count == 0)
                {
                    ...
                    Job2X_06_mask.SetValue(Job2X_06.Advanced_transfer_start, false);
                    ...
                    Job2X_06_mask.SetValue(Job2X_06.Defense_is_too_high, false);
            ...
            if (Job2X_06_mask.Test(Job2X_06.所有問題回答正確))//_3A99)
            {
                switch (Select(pc, "要轉職成為『元素術師』嗎？", "", "成為元素術師", "算了吧"))
                {
                    case 1:
                        ...
                        Job2X_06_mask.SetValue(Job2X_06.Defense_is_too_high, true);
                        //_4A13 = true;
                        Say(pc, 131, "防禦太高的話，就無法烙印紋章了$R;" +
                            "請換上輕便的服裝後，再來吧。$R;");
                        break;
            ...
            if (Job2X_06_mask.Test(Job2X_06.Advanced_transfer_start))//_3A93)
            {
                進階元素術師(pc);
                return;
            }
                ...
                while (a == 0)
                {
                    switch (Select(pc, "怎麼辦？？", "", "我要做『元素術師』喔！", "『元素術師』是怎樣的職業？", "任務服務台", "什麼都不做"))
                    {
                        case 1:
                            if (pc.Mag > 29)
                            {
                                Job2X_06_mask.SetValue(Job2X_06.Advanced_transfer_start, true);
                                //_3A93 = true;
                                //_3A89 = false;
                                Say(pc, 131, "呵呵…$R;" +
                                    "您想成為元素術師吧？$R;" +
