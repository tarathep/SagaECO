namespace SagaMap.Skill.SkillDefinations.Gambler
{
    ...
    /// <summary>
    /// Defines the <see cref="SumArcanaCard3" />.
    /// </summary>
    public class SumArcanaCard3 : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            SumArcanaCard3.SumArcanaCardBuff sumArcanaCardBuff = new SumArcanaCard3.SumArcanaCardBuff(args.skill, sActor, mob, lifetime);
