namespace SagaDB.Actor
{
    ...
    /// <summary>
    /// Defines the <see cref="VariableHolderA{K, T}" />.
    /// </summary>
    /// <typeparam name="K">.</typeparam>
    /// <typeparam name="T">.</typeparam>
    public class VariableHolderA<K, T> : IDictionary<K, T>, ICollection<KeyValuePair<K, T>>, IEnumerable<KeyValuePair<K, T>>, IEnumerable where T : new()
    {
        /// <summary>
        /// Defines the content.
        /// </summary>
