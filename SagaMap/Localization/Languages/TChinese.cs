namespace SagaMap.Localization.Languages
{
    ...
    /// <summary>
    /// Defines the <see cref="TChinese" />.
    /// </summary>
    public class TChinese : Strings
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TChinese"/> class.
        /// </summary>
        public TChinese()
        {
            this.VISIT_OUR_HOMEPAGE = "請訪問糢擬器SagaECO的主頁：https://econline.org";
        ...
        /// <summary>
        /// Gets the EnglishName.
        /// </summary>
        public override string EnglishName
        {
            get
            {
                return nameof(TChinese);
            }
        }
