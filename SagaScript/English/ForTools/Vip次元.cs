...
{
    public class S18000072 : Event
    {
        public S18000072()
        {
            this.EventID = 18000072;
        }
        ...
        public override void OnEvent(ActorPC pc)
        {
           ...
           if (CheckMapFlag(pc.SaveMap, MapFlags.Dominion) != CheckMapFlag(pc.MapID, MapFlags.Dominion))
            ...
            {
            switch (Select(pc, "次元印刻", "", "上城東邊吊橋", "各城市傳送", "各升級地點傳送", "NPC", "PVP鬥技場", "衝天塔", "VIP專用次元", "不用了"))
            {
                case 1:
                    if (pc.Gold >= 1)
                    {
                        TakeItem(pc, 27000046, 1);
                ...
                case 2:
                    ...
                    break;
                case 3:
                switch (Select(pc, "升級專區", "", "奧克魯尼亞叢林", "瑞路斯山道", "北方海角", "北方中央山脈", "永恆之北部極地", "奧克魯尼亞東海岸", "不死皇城", "鬼之寢岩", "南方海角", "奧克魯尼亞北部平原", "奧克魯尼亞東部平原", "奧克魯尼亞西部平原", "奧克魯尼亞南部平原", "果樹森林", "殺人蜂山路", "不死島嶼", "南部地牢3F", "南部地牢2F", "南部地牢1F", "馬克特碼頭", "大陸の洞窟Ｂ1Ｆ", "冰結の坑道Ｂ１Ｆ", "東部地牢", "光の塔 １Ｆ", "北部地牢", "牛牛草原", "光之塔頂層(A座)", "鐵火山", "大陸之洞穴Ｂ１Ｆ", "取消"))
                    {
                            case 1:
                    ...
                    break;
                                ...
                                case 7:
                                    ...
                                    break;
                                    case 8:
                                        switch (Select(pc, "VIP專用次元", "", "TEST", "取消"))
                                        {
                                            case 1:
                                                if (pc.Gold >= 1)
                                                {
