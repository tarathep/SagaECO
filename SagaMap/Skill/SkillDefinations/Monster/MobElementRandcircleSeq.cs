namespace SagaMap.Skill.SkillDefinations.Monster
{
    ...
    /// <summary>
    /// Defines the <see cref="MobElementRandcircleSeq" />.
    /// </summary>
    public class MobElementRandcircleSeq : ISkill
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MobElementRandcircleSeq"/> class.
        /// </summary>
        ...
        (short) SagaLib.Global.Random.Next((int) sActor.Y - 200, (int) sActor.Y + 200)
            ...
            List<SagaDB.Actor.Actor> actorsArea = map.GetActorsArea(numArray[0], numArray[1], (short)100, (SagaDB.Actor.Actor[])null);
            ...
            Singleton<SkillHandler>.Instance.MagicAttack(sActor, dActor1, args, this.e, MATKBonus);
