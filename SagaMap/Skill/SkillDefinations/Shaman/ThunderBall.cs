namespace SagaMap.Skill.SkillDefinations.Shaman
{
    ...
    /// <summary>
    /// Defines the <see cref="ThunderBall" />.
    /// </summary>
    public class ThunderBall : ISkill
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ThunderBall"/> class.
        /// </summary>
        public ThunderBall()
        {
            this.MobUse = false;
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            Singleton<SkillHandler>.Instance.MagicAttack(sActor, dActor, args, Elements.Wind, MATKBonus);
        }
    }
}
