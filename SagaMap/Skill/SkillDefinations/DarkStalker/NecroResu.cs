namespace SagaMap.Skill.SkillDefinations.DarkStalker
{
    ...
    /// <summary>
    /// Defines the <see cref="NecroResu" />.
    /// </summary>
    public class NecroResu : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(NecroResu), ifActivate);
        ...
        {
            actor.Status.autoReviveRate += (short)(15 * (int)skill.skill.Level);
        }
