namespace SagaMap.Skill.SkillDefinations.Scout
{
    ...
    /// <summary>
    /// Defines the <see cref="ShortSwordCancel" />.
    /// </summary>
    public class ShortSwordCancel : ISkill
    {
        ...
        private bool CheckPossible(SagaDB.Actor.Actor sActor)
        {
            ...
            return actorPc.Inventory.Equipments.ContainsKey(EnumEquipSlot.RIGHT_HAND) && (actorPc.Inventory.Equipments[EnumEquipSlot.RIGHT_HAND].BaseData.itemType == ItemType.SHORT_SWORD || Singleton<SkillHandler>.Instance.CheckDEMRightEquip(sActor, ItemType.PARTS_BLOW));
        }
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            if (!this.CheckPossible(possesionedActor))
                return;
            int lifetime = 20000;
            DefaultBuff defaultBuff = new DefaultBuff(args.skill, possesionedActor, nameof(ShortSwordCancel), lifetime);
