namespace SagaMap.Packets.Client
{
    ...
    /// <summary>
    /// Defines the <see cref="CSMG_GOLEM_SHOP_SELL_SETUP" />.
    /// </summary>
    public class CSMG_GOLEM_SHOP_SELL_SETUP : Packet
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CSMG_GOLEM_SHOP_SELL_SETUP"/> class.
        /// </summary>
        ...
        public string Comment
        {
            get
            {
                byte num = this.GetByte((ushort)(5 + (int)this.GetByte((ushort)2) * 10));
                return Global.Unicode.GetString(this.GetBytes((ushort)num, (ushort)(6 + (int)this.GetByte((ushort)2) * 10))).Replace("\0", "");
            }
        }
        ...
        {
            return (Packet)new CSMG_GOLEM_SHOP_SELL_SETUP();
        }
