namespace SagaMap.Skill.SkillDefinations.Command
{
    ...
    public class SealHMSp : ISkill
    {
        ...
        {
            int lifetime = 1000 + 3000 * (int)level;
            int num = 20 * (int)level - 10;
            if (SagaLib.Global.Random.Next(0, 99) >= num)
                return;
            DefaultBuff defaultBuff = new DefaultBuff(args.skill, dActor, nameof(SealHMSp), lifetime);
