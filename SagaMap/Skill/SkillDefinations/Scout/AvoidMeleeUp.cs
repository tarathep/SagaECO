namespace SagaMap.Skill.SkillDefinations.Scout
{
    ...
    /// <summary>
    /// Defines the <see cref="AvoidMeleeUp" />.
    /// </summary>
    public class AvoidMeleeUp : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultBuff defaultBuff = new DefaultBuff(args.skill, dActor, nameof(AvoidMeleeUp), lifetime);
        ...
        private void StartEventHandler(SagaDB.Actor.Actor actor, DefaultBuff skill)
        {
            ...
            if (skill.Variable.ContainsKey(nameof(AvoidMeleeUp)))
                skill.Variable.Remove(nameof(AvoidMeleeUp));
            skill.Variable.Add(nameof(AvoidMeleeUp), (int)num);
            actor.Status.avoid_melee_skill += num;
        ...
        {
            int num = skill.Variable[nameof(AvoidMeleeUp)];
            actor.Status.avoid_melee_skill -= (short)num;
