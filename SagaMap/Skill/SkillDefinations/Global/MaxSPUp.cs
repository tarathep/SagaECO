namespace SagaMap.Skill.SkillDefinations.Global
{
    ...
    public class MaxSPUp : ISkill
    {
        ...
        {
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(MaxSPUp), true);
        ...
        private void StartEventHandler(SagaDB.Actor.Actor actor, DefaultPassiveSkill skill)
        {
            ...
            int num2 = (int)((double)actor.MaxSP * (double)num1);
            ...
            skill.Variable.Add("SPValue", num2);
            actor.Status.sp_skill += (short)num2;
        }
        ...
        {
            int num = skill.Variable["SPValue"];
            actor.Status.sp_skill -= (short)num;
        }
    }
}
