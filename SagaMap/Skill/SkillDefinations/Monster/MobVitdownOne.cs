namespace SagaMap.Skill.SkillDefinations.Monster
{
    ...
    /// <summary>
    /// Defines the <see cref="MobVitdownOne" />.
    /// </summary>
    public class MobVitdownOne : ISkill
    {
        ...
        {
            int lifetime = 10000;
            DefaultBuff defaultBuff = new DefaultBuff(args.skill, dActor, nameof(MobVitdownOne), lifetime);
        ...
        private void StartEventHandler(SagaDB.Actor.Actor actor, DefaultBuff skill)
        {
            if (actor.type != ActorType.PC)
                return;
            int num = -(int)((double)((ActorPC)actor).Vit * 0.0500000007450581);
            if (skill.Variable.ContainsKey("MobVitdownOne_vit"))
                skill.Variable.Remove("MobVitdownOne_vit");
            skill.Variable.Add("MobVitdownOne_vit", num);
            actor.Status.vit_skill += (short)num;
