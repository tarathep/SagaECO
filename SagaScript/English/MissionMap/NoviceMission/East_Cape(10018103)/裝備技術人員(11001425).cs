...
namespace SagaScript.M10018103
{
    public class S11001425 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            selection = Select(pc, "想問什麼呢?", "", "ItemBox的使用方法", "ItemTicketExchange的使用方法", "沒有想問的");
            ...
            while (selection != 3)
            {
                switch (selection)
                {
                    ...
                    case 2:
                        Say(pc, 11001425, 131, "至於ItemTicketExchange，$R;" +
                                               "先點擊這個機械，$R;" +
                                               "然後選擇「道具票交換」。$R;" +
                                               "$P需要輸入編號時，$R;" +
                                               "在輸入視窗輸入正確「道具編號」。$R;" +
                ...
                selection = Select(pc, "想問什麼呢?", "", "ItemBox的使用方法", "ItemTicketExchange的使用方法", "沒有可問的");
            }        
        }
