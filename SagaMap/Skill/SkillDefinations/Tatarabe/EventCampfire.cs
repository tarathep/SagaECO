namespace SagaMap.Skill.SkillDefinations.Tatarabe
{
    ...
    /// <summary>
    /// Defines the <see cref="EventCampfire" />.
    /// </summary>
    public class EventCampfire : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            new EventCampfire.Activator(sActor, _dActor, args, level).Activate();
        }
            ...
            public override void CallBack(object o)
            {
                ...
                try
                {
                    if (this.lifetime > 0)
                    {
                        ...
                        uint num = (uint)this.skill.skill.Level * 10U;
                        List<SagaDB.Actor.Actor> actorsArea = this.map.GetActorsArea((SagaDB.Actor.Actor)this.actor, (short)200, false);
                        ...
                        Singleton<SkillHandler>.Instance.FixAttack(this.sActor, dActor, this.skill, Elements.Holy, (float)-num);
