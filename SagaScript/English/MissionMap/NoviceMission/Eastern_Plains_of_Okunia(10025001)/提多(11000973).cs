...
namespace SagaScript.M10025001
{
    public class S11000973 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            if (!Beginner_01_mask.Test(Beginner_01.Emil_gives_Emil_introduction_book) &&
                !Beginner_01_mask.Test(Beginner_01.Belial_gives_the_novice_ribbon))
            {
                提多給予初心者緞帶和埃米爾介紹信(pc);
                return;
            }
        ...
        void 提多給予初心者緞帶和埃米爾介紹信(ActorPC pc)
        {
            ...
            Say(pc, 11000973, 131, "這是初心者使用的裝備。$R;" +
                                   ...
                                   "$R說不定是尋找同伴的好地方唷!$R;" +
                                   "$P啊! 是的!$R;" +
                                   "前面的橋上有個叫「ResurrectionWarrior」的人。$R;" +
                                   "$P去他那裡找他說話吧!$R;" +
                                   "他曾說過他有方便的道具唷!$R;" +
                                   "從那邊的傳送點過去，$R;" +
                                   "就可以到達城市裡了。$R;" +
