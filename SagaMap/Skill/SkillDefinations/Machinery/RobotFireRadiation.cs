namespace SagaMap.Skill.SkillDefinations.Machinery
{
    ...
    /// <summary>
    /// Defines the <see cref="RobotFireRadiation" />.
    /// </summary>
    public class RobotFireRadiation : ISkill
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RobotFireRadiation"/> class.
        /// </summary>
        ...
        {
            float ATKBonus = (float)(1.85000002384186 + 0.200000002980232 * (double)level);
            ...
            Singleton<SkillHandler>.Instance.PhysicalAttack(sActor, dActor1, args, Elements.Fire, ATKBonus);
        }
    }
}
