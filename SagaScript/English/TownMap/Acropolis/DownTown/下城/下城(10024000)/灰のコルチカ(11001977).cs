...
namespace SagaScript.M10024000
{
    public class S11001977 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            {
                Say(pc, 131, "啊怎麼辦了$R;", "灰のコルチカ");
                switch (Select(pc, "怎麼辦？", "", "卡片是什麼", "擴充裝備插位", "聽擴充裝備插位的說明", "升級卡片", "聽升級卡片的說明"))
                {
                    case 1:
                        Say(pc, 131, "假如增加擴充裝備插位的話$R;" +
                        "要拿來需要的道具和$R;" +
                        "有一定的風險$R;" +
                        "所以要有心理準備哦！$R;", "灰のコルチカ");
                        break;
