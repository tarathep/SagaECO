...
namespace SagaScript.M30164000
{
    public class S11000231 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            if (Job2X_05_mask.Test(Job2X_05.Defense_is_too_high))//_4A12)
            {
                ...
                if (pc.Inventory.Equipments.Count == 0)
                {
                    ...
                    Job2X_05_mask.SetValue(Job2X_05.Defense_is_too_high, false);
            ...
            if (Job2X_05_mask.Test(Job2X_05.拒絕轉職))//_4A11)
            {
                switch (Select(pc, "轉職嗎?", "", "轉職", "不轉職"))
                {
                    case 1:
                        ...
                        Job2X_05_mask.SetValue(Job2X_05.Defense_is_too_high, true);
                        Say(pc, 131, "防禦能力太強$R紋章就不能烙印上去$R;" +
                            "先把裝備脫下來吧$R;");
                        break;
                    case 2:
