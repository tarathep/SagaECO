namespace SagaMap.Skill.SkillDefinations.Shaman
{
    ...
    /// <summary>
    /// Defines the <see cref="EarthWeapon" />.
    /// </summary>
    public class EarthWeapon : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultBuff defaultBuff = new DefaultBuff(args.skill, dActor, nameof(EarthWeapon), 50000);
        ...
        private void StartEventHandler(SagaDB.Actor.Actor actor, DefaultBuff skill)
        {
            ...
            (attackElements = actor.AttackElements)[Elements.Earth] = attackElements[Elements.Earth] + num;
