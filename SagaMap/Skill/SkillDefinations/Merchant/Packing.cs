namespace SagaMap.Skill.SkillDefinations.Merchant
{
    ...
    public class Packing : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(Packing), ifActivate);
        ...
        {
            skill[nameof(Packing)] = 10 * (int)skill.skill.Level;
        }
