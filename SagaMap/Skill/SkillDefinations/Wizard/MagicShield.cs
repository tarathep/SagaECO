namespace SagaMap.Skill.SkillDefinations.Wizard
{
    ...
    /// <summary>
    /// Defines the <see cref="MagicShield" />.
    /// </summary>
    public class MagicShield : ISkill
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MagicShield"/> class.
        /// </summary>
        public MagicShield()
        {
            this.MobUse = false;
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultBuff defaultBuff = new DefaultBuff(args.skill, dActor, nameof(MagicShield), lifetime);
