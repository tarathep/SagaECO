namespace SagaLib
{
    ...
    /// <summary>
    /// Defines the <see cref="FactoryString{K, T}" />.
    /// </summary>
    ...
    public abstract class FactoryString<K, T> where K : new() where T : new()
    {
        ...
        public static K Instance
        {
            get
            {
                return FactoryString<K, T>.SingletonHolder.instance;
            }
            set
            {
                FactoryString<K, T>.SingletonHolder.instance = value;
            }
        }
