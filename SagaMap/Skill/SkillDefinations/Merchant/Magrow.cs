namespace SagaMap.Skill.SkillDefinations.Merchant
{
    ...
    public class Magrow : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            if (!Singleton<SkillHandler>.Instance.CanAdditionApply(sActor, dActor, nameof(Magrow), rate))
                return;
            DefaultBuff defaultBuff = new DefaultBuff(args.skill, dActor, nameof(Magrow), lifetime);
        ...
        private void StartEventHandler(SagaDB.Actor.Actor actor, DefaultBuff skill)
        {
            ...
            int num = (int)((double)actor.Status.min_matk * (0.100000001490116 + 0.100000001490116 * (double)level));
            if (skill.Variable.ContainsKey("AtkUpOne_min_matk"))
                skill.Variable.Remove("AtkUpOne_min_matk");
            skill.Variable.Add("AtkUpOne_min_matk", num);
            actor.Status.min_matk_skill += (short)num;
        }
