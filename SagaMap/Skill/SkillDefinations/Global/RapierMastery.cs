namespace SagaMap.Skill.SkillDefinations.Global
{
    ...
    /// <summary>
    /// Defines the <see cref="RapierMastery" />.
    /// </summary>
    public class RapierMastery : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            if (actorPc.Inventory.Equipments.ContainsKey(EnumEquipSlot.RIGHT_HAND) && actorPc.Inventory.Equipments[EnumEquipSlot.RIGHT_HAND].BaseData.itemType == ItemType.RAPIER)
                ifActivate = true;
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(RapierMastery), ifActivate);
        ...
        private void StartEventHandler(SagaDB.Actor.Actor actor, DefaultPassiveSkill skill)
        {
            ...
            actor.Status.min_atk1_skill += (short)num;
            actor.Status.min_atk2_skill += (short)num;
            actor.Status.min_atk3_skill += (short)num;
        }
