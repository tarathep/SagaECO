namespace SagaMap.ActorEventHandlers
{
    ...
    /// <summary>
    /// Defines the <see cref="SkillEventHandler" />.
    /// </summary>
    public class SkillEventHandler : ActorEventHandler
    {
        /// <summary>
        /// Defines the ActorMove.
        /// </summary>
        public event SkillEventHandler.MoveEventHandler ActorMove;
        ...
        public void OnActorStartsMoving(SagaDB.Actor.Actor mActor, short[] pos, ushort dir, ushort speed)
        {
            if (this.ActorMove == null)
                return;
            this.ActorMove(mActor, pos, dir, speed);
        }
        ...
        /// <summary>
        /// The MoveEventHandler.
        /// </summary>
        /// <param name="mActor">The mActor<see cref="SagaDB.Actor.Actor"/>.</param>
        /// <param name="pos">The pos<see cref="short[]"/>.</param>
        /// <param name="dir">The dir<see cref="ushort"/>.</param>
        /// <param name="speed">The speed<see cref="ushort"/>.</param>
        public delegate void MoveEventHandler(SagaDB.Actor.Actor mActor, short[] pos, ushort dir, ushort speed);
    }
}
