namespace SagaMap.Skill.SkillDefinations.Marionest
{
    ...
    public class SumMario : ISkill
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SumMario"/> class.
        /// </summary>
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            args.autoCast.Add(Singleton<SkillHandler>.Instance.CreateAutoCastInfo(this.NextSkillID, level, 500));
        }
    }
}
