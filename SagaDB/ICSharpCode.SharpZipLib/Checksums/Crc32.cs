namespace ICSharpCode.SharpZipLib.Checksums
{
    ...
    /// <summary>
    /// Defines the <see cref="Crc32" />.
    /// </summary>
    public sealed class Crc32 : IChecksum
    {
        /// <summary>
        /// Defines the CrcTable.
        /// </summary>
      ...
      755167117U
        ...
        /// The ComputeCrc32.
        /// </summary>
        /// <param name="oldCrc">The oldCrc<see cref="uint"/>.</param>
        /// <param name="value">The value<see cref="byte"/>.</param>
        /// <returns>The <see cref="uint"/>.</returns>
        internal static uint ComputeCrc32(uint oldCrc, byte value)
        {
            return Crc32.CrcTable[(int)(uint)(((int)oldCrc ^ (int)value) & (int)byte.MaxValue)] ^ oldCrc >> 8;
        }
        ...
        public void Update(byte[] buffer, int offset, int count)
        {
            ...
            this.crc ^= uint.MaxValue;
            while (--count >= 0)
                this.crc = Crc32.CrcTable[(int)(uint)(((int)this.crc ^ (int)buffer[offset++]) & (int)byte.MaxValue)] ^ this.crc >> 8;
            this.crc ^= uint.MaxValue;
        }
    }
}
