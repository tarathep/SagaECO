namespace SagaMap.Skill.Additions.Global
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpUp"/> class.
        /// </summary>
        ...
        public ExpUp(SagaDB.Skill.Skill skill, SagaDB.Actor.Actor actor, int lifetime)
      : base(skill, actor, nameof(ExpUp), lifetime)
        {
