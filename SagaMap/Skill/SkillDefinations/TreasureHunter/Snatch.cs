namespace SagaMap.Skill.SkillDefinations.TreasureHunter
{
    ...
    public class Snatch : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            int num = 2 * (int)level;
            if (SagaLib.Global.Random.Next(0, 99) >= num || dActor.Status.Additions.ContainsKey(nameof(Snatch)))
                return;
            DefaultBuff defaultBuff = new DefaultBuff(args.skill, dActor, nameof(Snatch), int.MaxValue);
