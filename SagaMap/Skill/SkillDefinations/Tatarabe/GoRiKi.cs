namespace SagaMap.Skill.SkillDefinations.Tatarabe
{
    ...
    public class GoRiKi : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(GoRiKi), ifActivate);
        ...
        {
            skill[nameof(GoRiKi)] = 10 * (int)skill.skill.Level;
        }
