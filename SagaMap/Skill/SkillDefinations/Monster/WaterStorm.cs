namespace SagaMap.Skill.SkillDefinations.Monster
{
    ...
    /// <summary>
    /// Defines the <see cref="WaterStorm" />.
    /// </summary>
    public class WaterStorm : ISkill
    {
        ...
        {
            float MATKBonus = 1.15f;
            ActorSkill actorSkill = new ActorSkill(args.skill, sActor);
            Map map = Singleton<MapManager>.Instance.GetMap(sActor.MapID);
            List<SagaDB.Actor.Actor> actorsArea = map.GetActorsArea(SagaLib.Global.PosX8to16(args.x, map.Width), SagaLib.Global.PosY8to16(args.y, map.Height), (short)300, new SagaDB.Actor.Actor[0]);
