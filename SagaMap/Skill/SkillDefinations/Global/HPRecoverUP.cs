namespace SagaMap.Skill.SkillDefinations.Global
{
    ...
    /// <summary>
    /// Defines the <see cref="HPRecoverUP" />.
    /// </summary>
    public class HPRecoverUP : ISkill
    {
        ...
        {
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(HPRecoverUP), true);
        ...
        private void StartEventHandler(SagaDB.Actor.Actor actor, DefaultPassiveSkill skill)
        {
            ...
            skill.Variable.Add("HPRecover", level);
            actor.Status.hp_recover_skill += (short)level;
        }
        ...
        {
            int num = skill.Variable["HPRecover"];
            actor.Status.hp_recover_skill -= (short)num;
        }
    }
}
