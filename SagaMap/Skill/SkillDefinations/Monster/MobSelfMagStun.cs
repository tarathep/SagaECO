namespace SagaMap.Skill.SkillDefinations.Monster
{
    ...
    /// <summary>
    /// Defines the <see cref="MobSelfMagStun" />.
    /// </summary>
    public class MobSelfMagStun : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            {
                if (Singleton<SkillHandler>.Instance.CheckValidAttackTarget(sActor, actor) && Singleton<SkillHandler>.Instance.CanAdditionApply(sActor, actor, SkillHandler.DefaultAdditions.Silence, rate))
                {
