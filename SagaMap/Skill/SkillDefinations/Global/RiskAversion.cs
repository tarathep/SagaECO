namespace SagaMap.Skill.SkillDefinations.Global
{
    ...
    /// <summary>
    /// Defines the <see cref="RiskAversion" />.
    /// </summary>
    public class RiskAversion : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(RiskAversion), ifActivate);
        ...
        {
            actor.Status.possessionCancel = (short)(10 * (int)skill.skill.Level);
        }
        ...
        {
            actor.Status.possessionCancel = (short)0;
        }
    }
}
