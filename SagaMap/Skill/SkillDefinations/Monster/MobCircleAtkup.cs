namespace SagaMap.Skill.SkillDefinations.Monster
{
    ...
    /// <summary>
    /// Defines the <see cref="MobCircleAtkup" />.
    /// </summary>
    public class MobCircleAtkup : ISkill
    {
        ...
        {
            int lifetime = 10000;
            DefaultBuff defaultBuff = new DefaultBuff(args.skill, dActor, nameof(MobCircleAtkup), lifetime);
