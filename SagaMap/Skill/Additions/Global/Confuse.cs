namespace SagaMap.Skill.Additions.Global
{
    ...
    /// <summary>
    /// Defines the <see cref="Confuse" />.
    /// </summary>
    public class Confuse : DefaultBuff
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Confuse"/> class.
        /// </summary>
        ...
        public Confuse(SagaDB.Skill.Skill skill, SagaDB.Actor.Actor actor, int lifetime)
      : base(skill, actor, nameof(Confuse), lifetime)
        {
