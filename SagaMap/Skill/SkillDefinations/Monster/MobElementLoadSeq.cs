namespace SagaMap.Skill.SkillDefinations.Monster
{
    ...
    /// <summary>
    /// Defines the <see cref="MobElementLoadSeq" />.
    /// </summary>
    public class MobElementLoadSeq : ISkill
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MobElementLoadSeq"/> class.
        /// </summary>
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            List<SagaDB.Actor.Actor> actorsArea = map.GetActorsArea((SagaDB.Actor.Actor)actorSkill, (short)100, false);
