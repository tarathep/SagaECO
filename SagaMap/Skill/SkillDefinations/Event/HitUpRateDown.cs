namespace SagaMap.Skill.SkillDefinations.Event
{
    ...
    /// <summary>
    /// Defines the <see cref="HitUpRateDown" />.
    /// </summary>
    public class HitUpRateDown : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(HitUpRateDown), ifActivate);
        ...
        {
            actor.Status.hit_ranged_skill += (short)15;
            actor.Status.hit_melee_skill += (short)15;
        }
