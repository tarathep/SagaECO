namespace SagaMap.Skill.SkillDefinations.Global
{
    ...
    public class MaxHPUp : ISkill
    {
        ...
        {
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(MaxHPUp), true);
        ...
        private void StartEventHandler(SagaDB.Actor.Actor actor, DefaultPassiveSkill skill)
        {
            ...
            int num2 = (int)((double)actor.MaxHP * (double)num1);
            ...
            skill.Variable.Add("HPValue", num2);
            actor.Status.hp_skill += (short)num2;
        }
        ...
        {
            int num = skill.Variable["HPValue"];
            actor.Status.hp_skill -= (short)num;
        }
    }
}
