namespace SagaMap.Skill.SkillDefinations.Global
{
    ...
    /// <summary>
    /// Defines the <see cref="SumSlaveMob" />.
    /// </summary>
    public class SumSlaveMob : ISkill
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SumSlaveMob"/> class.
        /// </summary>
            ...
            else
            {
                ...
                if (num == 0)
                {
                    for (int index = 0; index < sActor.Slave.Count; ++index)
                    {
                        ...
                        {
                            short[] randomPosAroundActor = map.GetRandomPosAroundActor(sActor);
                            sActor.Slave[index] = (SagaDB.Actor.Actor)map.SpawnMob(this.MobID, randomPosAroundActor[0], randomPosAroundActor[1], (short)2500, sActor);
                        }
                    }
                }
            }
