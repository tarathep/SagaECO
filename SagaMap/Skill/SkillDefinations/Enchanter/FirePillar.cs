namespace SagaMap.Skill.SkillDefinations.Enchanter
{
    ...
    /// <summary>
    /// Defines the <see cref="FirePillar" />.
    /// </summary>
    public class FirePillar : ISkill
    {
        ...
        public int TryCast(ActorPC pc, SagaDB.Actor.Actor dActor, SkillArg args)
        {
            ...
            if ((int)args.x >= (int)map.Width || (int)args.y >= (int)map.Height)
                return -6;
            return map.Info.fire[(int)args.x, (int)args.y] > (byte)0 ? 0 : -12;
        }
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            new FirePillar.Activator(sActor, _dActor, args, level).Activate();
        }
        ...
        private class Activator : MultiRunTask
        {
            ...
            public Activator(SagaDB.Actor.Actor _sActor, ActorSkill _dActor, SkillArg _args, byte level)
            {
                ...
                this.factor = (float)(0.400000005960464 + 0.100000001490116 * (double)level);
                this.dueTime = 0;
                this.period = 500;
                this.lifetime = (4000 + 1000 * (int)level) / this.period;
            ...
            public override void CallBack(object o)
            {
                ...
                try
                {
                    if (this.lifetime > 0)
                    {
                        List<SagaDB.Actor.Actor> actorsArea = this.map.GetActorsArea((SagaDB.Actor.Actor)this.actor, (short)50, true);
                        ...
                        Singleton<SkillHandler>.Instance.MagicAttack(this.sActor, dActor1, this.skill, Elements.Fire, this.factor);
