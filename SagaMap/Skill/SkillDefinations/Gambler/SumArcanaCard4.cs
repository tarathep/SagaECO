namespace SagaMap.Skill.SkillDefinations.Gambler
{
    ...
    /// <summary>
    /// Defines the <see cref="SumArcanaCard4" />.
    /// </summary>
    public class SumArcanaCard4 : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            ((MobEventHandler)mob.e).AI.Mode = new AIMode(0);
            SumArcanaCard4.SumArcanaCardBuff sumArcanaCardBuff = new SumArcanaCard4.SumArcanaCardBuff(args.skill, sActor, mob, lifetime);
            SkillHandler.ApplyAddition(sActor, (Addition)sumArcanaCardBuff);
            Singleton<SkillHandler>.Instance.FixAttack((SagaDB.Actor.Actor)mob, sActor, args, Elements.Holy, -600f);
        }
