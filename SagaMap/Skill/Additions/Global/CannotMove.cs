namespace SagaMap.Skill.Additions.Global
{
    ...
    /// <summary>
    /// Defines the <see cref="CannotMove" />.
    /// </summary>
    public class CannotMove : DefaultBuff
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CannotMove"/> class.
        /// </summary>
        ...
        public CannotMove(SagaDB.Skill.Skill skill, SagaDB.Actor.Actor actor, int lifetime)
      : base(skill, actor, nameof(CannotMove), lifetime)
        {
