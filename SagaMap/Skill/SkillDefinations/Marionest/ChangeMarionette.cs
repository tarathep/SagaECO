namespace SagaMap.Skill.SkillDefinations.Marionest
{
    ...
    /// <summary>
    /// Defines the <see cref="ChangeMarionette" />.
    /// </summary>
    public class ChangeMarionette : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(ChangeMarionette), ifActivate);
