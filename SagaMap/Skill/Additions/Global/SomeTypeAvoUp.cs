namespace SagaMap.Skill.Additions.Global
{
    ...
    /// <summary>
    /// Defines the <see cref="SomeTypeAvoUp" />.
    /// </summary>
    public class SomeTypeAvoUp : DefaultPassiveSkill
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SomeTypeAvoUp"/> class.
        /// </summary>
        /// <param name="skill">The skill<see cref="SagaDB.Skill.Skill"/>.</param>
        /// <param name="actor">The actor<see cref="SagaDB.Actor.Actor"/>.</param>
        /// <param name="name">The name<see cref="string"/>.</param>
        public SomeTypeAvoUp(SagaDB.Skill.Skill skill, SagaDB.Actor.Actor actor, string name)
      : base(skill, actor, name, true)
        ...
        public SomeTypeAvoUp(SagaDB.Skill.Skill skill, SagaDB.Actor.Actor actor, string name, int peroid, int lifetime)
