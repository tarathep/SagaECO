namespace SagaMap.Skill.SkillDefinations.Breeder
{
    ...
    /// <summary>
    /// Defines the <see cref="LionPower" />.
    /// </summary>
    public class LionPower : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            if (pet == null)
                return;
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, (SagaDB.Actor.Actor)pet, nameof(LionPower), true);
        ...
        {
            int num = (int)((double)actor.MaxHP * 0.100000001490116);
            if (skill.Variable.ContainsKey("Encouragement_MaxHP"))
                skill.Variable.Remove("Encouragement_MaxHP");
            skill.Variable.Add("Encouragement_MaxHP", num);
            actor.MaxHP += (uint)num;
        }
