namespace SagaMap.Skill.Additions.Global
{
    ...
    /// <summary>
    /// Defines the <see cref="SomeTypeDamUp" />.
    /// </summary>
    public class SomeTypeDamUp : DefaultPassiveSkill
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SomeTypeDamUp"/> class.
        /// </summary>
        /// <param name="skill">The skill<see cref="SagaDB.Skill.Skill"/>.</param>
        /// <param name="actor">The actor<see cref="SagaDB.Actor.Actor"/>.</param>
        /// <param name="name">The name<see cref="string"/>.</param>
        public SomeTypeDamUp(SagaDB.Skill.Skill skill, SagaDB.Actor.Actor actor, string name)
      : base(skill, actor, name, true)
        ...
        public SomeTypeDamUp(SagaDB.Skill.Skill skill, SagaDB.Actor.Actor actor, string name, int peroid, int lifetime)
