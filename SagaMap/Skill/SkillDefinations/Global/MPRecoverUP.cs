namespace SagaMap.Skill.SkillDefinations.Global
{
    ...
    /// <summary>
    /// Defines the <see cref="MPRecoverUP" />.
    /// </summary>
    public class MPRecoverUP : ISkill
    {
        ...
        {
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(MPRecoverUP), true);
        ...
        private void StartEventHandler(SagaDB.Actor.Actor actor, DefaultPassiveSkill skill)
        {
            ...
            skill.Variable.Add("MPRecover", level);
            actor.Status.mp_recover_skill += (short)level;
        }
        ...
        {
            int num = skill.Variable["MPRecover"];
            actor.Status.mp_recover_skill -= (short)num;
        }
    }
}
