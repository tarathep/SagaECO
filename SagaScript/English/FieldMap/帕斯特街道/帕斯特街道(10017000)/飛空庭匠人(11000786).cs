...
namespace SagaScript.M10017000
{
    public class S11000786 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            if (fgarden.Test(FGarden.Get_the_key_to_the_sky_court) && CountItem(pc, 10022700) == 0)
            {
            ...
            if (SInt["FGarden_Potion"] < 50000 && !fgarden.Test(FGarden.Get_the_key_to_the_sky_court))
            {
                傑利科藥水不夠(pc);
                return;
            }
            ...
            if (SInt["FGarden_Potion"] > 49000 && !fgarden.Test(FGarden.Get_the_key_to_the_sky_court))
            {
                傑利科藥水夠了(pc);
                return;
            }
        ...
        void 製作飛空庭(ActorPC pc)
        {
                ...
                parts.Test(FGardenParts.Catalyst))
            {
                ...
                GiveItem(pc, 10022700, 1);
                fgarden.SetValue(FGarden.Get_the_key_to_the_sky_court, true);
            }
