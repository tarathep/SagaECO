namespace SagaMap.Skill.SkillDefinations.Gambler
{
    ...
    public class DoubleUp : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(DoubleUp), ifActivate);
        ...
        {
            actor.Status.doubleUpList.Add((ushort)2127);
            actor.Status.doubleUpList.Add((ushort)3286);
            actor.Status.doubleUpList.Add((ushort)3287);
            actor.Status.doubleUpList.Add((ushort)2374);
            actor.Status.doubleUpList.Add((ushort)2375);
        }
