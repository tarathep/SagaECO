namespace SagaMap.Skill.SkillDefinations.Merchant
{
    ...
    /// <summary>
    /// Defines the <see cref="BuyRateDown" />.
    /// </summary>
    public class BuyRateDown : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(BuyRateDown), ifActivate);
        ...
        {
            int num = (int)-skill.skill.Level * 2;
            skill["BuyRate"] = num;
            actor.Status.buy_rate += (short)num;
        }
