namespace SagaMap.Skill.SkillDefinations.BladeMaster
{
    ...
    /// <summary>
    /// Defines the <see cref="DoubleCutDownSeq" />.
    /// </summary>
    public class DoubleCutDownSeq : ISkill
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DoubleCutDownSeq"/> class.
        /// </summary>
        public DoubleCutDownSeq()
        {
            ...
            this.range[SkillHandler.ActorDirection.NorthEast].Add(Singleton<SkillHandler>.Instance.CalcPosHashCode(1, 1, 2));
            ...
            this.range[SkillHandler.ActorDirection.SouthEast].Add(Singleton<SkillHandler>.Instance.CalcPosHashCode(1, -1, 2));
            ...
            this.range[SkillHandler.ActorDirection.SouthWest].Add(Singleton<SkillHandler>.Instance.CalcPosHashCode(-1, -1, 2));
            ...
            this.range[SkillHandler.ActorDirection.NorthWest].Add(Singleton<SkillHandler>.Instance.CalcPosHashCode(-1, 1, 2));
