namespace SagaMap.Skill.SkillDefinations.Tatarabe
{
    ...
    /// <summary>
    /// Defines the <see cref="ThrowDirt" />.
    /// </summary>
    public class ThrowDirt : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            if (!Singleton<SkillHandler>.Instance.CanAdditionApply(sActor, dActor, nameof(ThrowDirt), rate))
                return;
            int lifetime = 35000 - 5000 * (int)level;
            DefaultBuff defaultBuff = new DefaultBuff(args.skill, dActor, nameof(ThrowDirt), lifetime);
