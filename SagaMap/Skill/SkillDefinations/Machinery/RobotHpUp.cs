namespace SagaMap.Skill.SkillDefinations.Machinery
{
    ...
    /// <summary>
    /// Defines the <see cref="RobotHpUp" />.
    /// </summary>
    public class RobotHpUp : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            if (Singleton<SkillHandler>.Instance.CheckMobType((ActorMob)pet, "MACHINE_RIDE_ROBOT"))
                ifActivate = true;
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(RobotHpUp), ifActivate);
        ...
        {
            actor.MaxHP += (uint)(0.0700000002980232 + 0.0299999993294477 * (double)skill.skill.Level);
        }
        ...
        {
            actor.MaxHP -= (uint)(1.07000005245209 + 0.0299999993294477 * (double)skill.skill.Level);
        }
    }
}
