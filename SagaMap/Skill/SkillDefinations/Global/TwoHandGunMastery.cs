namespace SagaMap.Skill.SkillDefinations.Global
{
    ...
    /// <summary>
    /// Defines the <see cref="TwoHandGunMastery" />.
    /// </summary>
    public class TwoHandGunMastery : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            if (sActor.type != ActorType.PC)
                return;
            if (Singleton<SkillHandler>.Instance.isEquipmentRight(sActor, ItemType.DUALGUN, ItemType.SPEAR))
                ifActivate = true;
            DefaultPassiveSkill defaultPassiveSkill = new DefaultPassiveSkill(args.skill, sActor, nameof(TwoHandGunMastery), ifActivate);
