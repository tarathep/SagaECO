namespace SagaMap.Skill.SkillDefinations.Monster
{
    ...
    /// <summary>
    /// Defines the <see cref="MobSelfDarkHighStorm" />.
    /// </summary>
    public class MobSelfDarkHighStorm : ISkill
    {
        ...
        {
            float MATKBonus = 3.5f;
            List<SagaDB.Actor.Actor> actorsArea = Singleton<MapManager>.Instance.GetMap(sActor.MapID).GetActorsArea(sActor, (short)600, false);
