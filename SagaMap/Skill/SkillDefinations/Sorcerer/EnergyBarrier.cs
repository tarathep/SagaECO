namespace SagaMap.Skill.SkillDefinations.Sorcerer
{
    ...
    /// <summary>
    /// Defines the <see cref="EnergyBarrier" />.
    /// </summary>
    public class EnergyBarrier : ISkill
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnergyBarrier"/> class.
        /// </summary>
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            foreach (SagaDB.Actor.Actor actor in actorsArea)
            {
                if (actor.type == ActorType.PC)
                {
                    ...
                    DefaultBuff defaultBuff = new DefaultBuff(args.skill, actor, nameof(EnergyBarrier), lifetime);
