namespace SagaMap.Skill.SkillDefinations.Monster
{
    ...
    /// <summary>
    /// Defines the <see cref="MobWindRandcircleSeq2" />.
    /// </summary>
    public class MobWindRandcircleSeq2 : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            List<SagaDB.Actor.Actor> actorsArea = map.GetActorsArea(randomPosAroundActor[0], randomPosAroundActor[1], (short)300, (SagaDB.Actor.Actor[])null);
            ...
            args.x = SagaLib.Global.PosX16to8(randomPosAroundActor[0], map.Width);
            args.y = SagaLib.Global.PosY16to8(randomPosAroundActor[1], map.Height);
        }
    }
}
