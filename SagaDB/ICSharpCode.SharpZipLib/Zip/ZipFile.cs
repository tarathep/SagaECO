namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public class ZipFile : IEnumerable, IDisposable
    {
        ...
        {
            return this.NameTransform != null ? this.NameTransform.TransformFile(name) : name;
        }

        private string GetTransformedDirectoryName(string name)
        {
            return this.NameTransform != null ? this.NameTransform.TransformDirectory(name) : name;
        }
