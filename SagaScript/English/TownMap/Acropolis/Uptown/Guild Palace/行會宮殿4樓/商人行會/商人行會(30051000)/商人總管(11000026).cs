...
namespace SagaScript.M30051000
{
    public class S11000026 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            if (Job2X_12_mask.Test(Job2X_12.Defense_is_too_high))
            {
                ...
                if (pc.Inventory.Equipments.Count == 0)
                {
                    ...
                    Job2X_12_mask.SetValue(Job2X_12.Defense_is_too_high, false);
            ...
            Say(pc, 11000026, 131, "您好，welcome商人行會。$R;", "商人總管");
        ...
        void Advanced_transfer判斷(ActorPC pc)
        {
            BitMask<Job2X_12> Job2X_12_mask = pc.CMask["Job2X_12"];
        ...
        void Advanced_transfer_selection(ActorPC pc)
        {
            ...
            switch (Select(pc, "真的要轉職嗎?", "", "我想成為貿易商", "還是算了吧"))
            {
                case 1:
                    ...
                    Job2X_12_mask.SetValue(Job2X_12.Defense_is_too_high, true);
                    //_3A66 = true;
                    Say(pc, 131, "防禦太高的話，就無法烙印紋章了$R;" +
                        "請換上輕便的服裝後，再來吧。$R;");
                    break;
